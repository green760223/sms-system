defmodule SmsSystemWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SmsSystemWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SmsSystemWeb.Gettext, "errors", msg, opts)
    end
  end
