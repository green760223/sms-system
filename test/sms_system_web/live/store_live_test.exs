defmodule SmsSystemWeb.StoreLiveTest do
  use SmsSystemWeb.ConnCase

  import Phoenix.LiveViewTest
  import SmsSystem.StoresManagementFixtures

  @create_attrs %{city: "some city", name: "some name", state: "some state", store_id: "some store_id", street: "some street", zipcode: "some zipcode"}
